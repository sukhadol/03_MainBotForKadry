...
help_message = text(
    ...
    "\nКроме того, информация в канале автоматически наполняется из постов группы Facebook \"Карьера в закупках: Вакансии & Кандидаты\" (https://www.facebook.com/groups/1013708529168332)",
	sep="\n"
)
